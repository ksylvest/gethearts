...
const About: NextPage = () => (
  <Wrapper>
    <div id="overview">
      <h1>Overview</h1>
      <p>
        Hearts is a game where players must evade taking points (Hearts and the
        Queen of Spades) or boldly attempt to collect all points and shoot the
        moon! The game originated in Spain in the 1700’s, and requires a mix of
        memory and strategy to be played well.
      </p>
      <p>
        Hearts requires four players (our game provides three computers to play
        against) and a standard deck of 52-cards (we use one of the digital
        variety). At the start of a round all cards are dealt. Each player is
        then required to pass three cards to a neighbour (left, right, across,
        and then no pass). Once the cards are passed the player with the lowest
        card (the Two of Clubs) plays first. Each trick players must follow suit
        if possible. The player with the highest card matching the suit led
        takes the trick and must lead the next card.
      </p>
      <p>
        ...
        Round are repeated until a player exceeds 100 points, at which point the
    ...
    <div id="developers">
      ...
      <p>
        ...
        Waterloo, Ontario. The project was created by two developers who greatly
        appreciate your support and hope you enjoy our software:
      </p>
      <div className={styles.developer}>
        ...
        <div className={styles.developer_bio}>
          ...
          <p>
            ...
            developer with a flair for style. Kevin has created a number of open
            source Rails and iOS libraries and is an active member of the
      ...
      <div className={styles.developer}>
        ...
        <div className={styles.developer_bio}>
          ...
          <p>
            ...
            time he plays soccer and is currently working on finishing is first
            novel.
          </p>
        </div>
      </div>
